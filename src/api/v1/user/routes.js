 ...
 * 
 * @apiParam {String} company    CompanyName
 * @apiParam {String} firstName  First Name
 * @apiParam {String} lastName   Last Name
 * @apiParam {String} email      Email
 * @apiParam {String} password   Password
 * 
 * @apiSuccess {Object} token    Access Token's object (accessToken: String, refreshToken: String, expiresIn: String)
 * @apiSuccess {Object} user     User detail object {_id: String, firstName: String, lastName: String, email: String}
 * 
 * @apiError (Bad Request 400) ValidationError Some parameters may contain invalid values
 * @apiError (Conflict 409)    ValidationError Email address already exists
 */
 ...
 * @apiDescription Login an account
 * @apiVersion 1.0.0
 * @apiName loginUser
 * @apiGroup User
 * @apiPermission public
 ...
 * @apiDescription Logout from an account
 * @apiVersion 1.0.0
 * @apiName logoutUser
 * @apiGroup User
 * @apiPermission private
 ...
 * @apiError (Conflict 409)  ValidationError  Old password and New Password the same.
 ...
 * @apiError (Conflict 409)  ValidationError  Old password and New Password are the same.
 * @apiSuccess (No Content 204) No Content
 */
 ...
 * @apiDescription Company admin can add multiple users
 * @apiVersion 1.0.0
 * @apiName Add People
 * @apiGroup User
 * @apiPermission private
